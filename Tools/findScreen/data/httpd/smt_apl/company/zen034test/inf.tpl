...
<li><span class="t-result font-4">
	<!--{def icon_80}-->華屋与兵衛&nbsp;<!--{/def}-->
	<!--{def icon_90}-->和食よへい&nbsp;<!--{/def}-->
	{rval name}</span></li>
</ul>
</div>
<!--{def addr}-->
...
<div class="z_litem"><p><span class="z_litem_comment">
	<!--{def col_03l8}-->
	<img src="{rval _cgiSysIconimg}00308" alt="華屋与兵衛" title="華屋与兵衛">
	<!--{/def}-->
	<!--{def col_03l9}-->
	<img src="{rval _cgiSysIconimg}00309" alt="和食よへい" title="和食よへい">
	<!--{/def}-->
	<!--{def col_30l1}-->
	...
	<!--{/def}-->
	<!--{def col_74b}-->
	<img src="{rval _cgiSysIconimg}072" alt="交通系電子マネー" title="交通系電子マネー">
	<!--{/def}-->	
	<!--{def col_78b}-->
	<img src="{rval _cgiSysIconimg}072" alt="Edy利用可" title="Edy利用可">
	<!--{/def}-->	
	<!--{def col_58b}-->
	<img src="{rval _cgiSysIconimg}072" alt="iD利用可" title="iD利用可">
	<!--{/def}-->	
	<!--{def col_57b}-->
	<img src="{rval _cgiSysIconimg}072" alt="QUICPay利用可" title="QUICPay利用可">
	<!--{/def}-->
	<!--{def col_72b}-->
