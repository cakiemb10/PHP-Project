...
<form name="formCond">
	<div class="cust_cond_panel">
		...
		<ul>
			...
			<li><input type="checkbox" name="cond26" id="cond26" value="COL_57:1" {rval cond25_sel} /><label for="cond26"><img src="{rval _cgiSysIconimg}057"/>交通系電子マネー</label></li>			
			<li><input type="checkbox" name="cond27" id="cond27" value="COL_058:1" {rval cond25_sel} /><label for="cond27"><img src="{rval _cgiSysIconimg}058" />Edy利用可</label></li>			
			<li><input type="checkbox" name="cond28" id="cond28" value="COL_58:1" {rval cond25_sel} /><label for="cond28"><img src="{rval _cgiSysIconimg}058" />iD利用可</label></li>						
			<li><input type="checkbox" name="cond29" id="cond29" value="COL_74:1" {rval cond25_sel} /><label for="cond29"><img src="{rval _cgiSysIconimg}074"/>QUICPay利用可</label></li>
