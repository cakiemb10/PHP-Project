...
<!--{/def}-->
<!--{def _jsLocCallbackNList}-->
<script type="text/JavaScript">
<!--
{rval _jsLocCallbackNList}
//-->
</script>
<!--{/def}-->
...
<header id="top" class="custHeaderCommon custUiHeader custUiBarA" data-nobackbtn="true" data-role="header" role="banner">
