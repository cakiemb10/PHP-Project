<?php
/*========================================================*/
// ファイル名：lw_searchpoijnr.cgi
// 処理名：【ローソン向けカスタマイズ】施設ジャンル検索
//
// 更新履歴
...
$JNRNM		= getCgiParameter('jnrmn','00000');		/* ジャンルメニューコード */
$JNR		= getCgiParameter('jnr','00000');		/* ジャンルコード */
...
switch ($OUTF) {
	...
	default:
		// TSV出力
		header("Content-Type: zdc-api/searchpoijnr");
		echo $result;
}
