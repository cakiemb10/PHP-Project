...
<!--{ndef main}-->
	...
	<!--{def checkboxopt}-->
		<br>
		&lt;ｻｰﾋﾞｽで探す&gt;<br>
		<input type="checkbox" name="C54" value="1">華屋与兵衛<br>
		<input type="checkbox" name="C55" value="1">和食よへい<br>
		<input type="submit" value="検　索"><hr>
		<input type="checkbox" name="K21" value="1">朝食ﾊﾞｲｷﾝｸﾞ<br>
		<input type="checkbox" name="K22" value="1">食べ放題<br>
		<input type="checkbox" name="K5" value="1">ﾄﾞﾘﾝｸﾊﾞｰ<br>
		<input type="submit" value="検　索"><hr>
		...
		<input type="checkbox" name="K16" value="1">店舗ﾌﾛｱ1F<br>
		<input type="checkbox" name="K17" value="1">駐車場<br>
		<input type="checkbox" name="K19" value="1">ｸﾚｼﾞｯﾄｶｰﾄﾞ利用可<br>
		<input type="checkbox" name="K24" value="1">交通系電子マネー<br>
		<input type="checkbox" name="K25" value="1">Edy利用可<br>
		<input type="checkbox" name="K26" value="1">iD利用可<br>
		<input type="checkbox" name="K27" value="1">QUICPay利用可<br>
		<input type="checkbox" name="K23" value="1">ZENSHO CooCa取扱店<br>
		<input type="submit" value="検　索"><br>
	<!--{/def}-->
</form>
<!--{/ndef}-->
